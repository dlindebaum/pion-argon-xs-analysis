...
class SampleDefinition:
    ...
    @classmethod
    def CreateDefinitions(cls, particle_counts : dict[ak.Array], uncategorised = False) -> dict[ak.Array]:
        ...
        """
        particle_list = list(cls.criteria_list.__dataclass_fields__.keys())
        ...
        masks = {}
        for n, p_c in cls.definitions.items():
